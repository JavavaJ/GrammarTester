...
public class Question implements Serializable {
    ...
    /**
     * The Question(String text) constructor is actually is a parser of a text
     * of a multiple choice test question of format "id. A) ..... B) ...... C)
     * ..... D) ...... .
     */
     ...
     * of a multiple choice test question of format "id. A) ..... B) ...... C)
     * ..... D) ...... or "id. a) ..... b) ...... c) ..... d) ...... . The
     * second parameter is an enum indicating a question option's delimiter's
     * case.
     *
    ...
    /**
     * Returns an id integer of a question which is non-zero based ordinal
     * number of question.
     *
     * @return id integer of a question which is non-zero based ordinal number
     * of question
     */
    public int getId() {
        return id;
     ...
     *
     * @param rightAns a String (a, b, c, d) which represent a right answer of a
     * Question
     */
